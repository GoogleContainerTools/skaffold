...
func NewResolver(ctx context.Context, pipelines []latestV1.Pipeline, cliPlatformsSelection []string, runMode config.RunMode, kubeContext string) (Resolver, error) {
	r := Resolver{}
