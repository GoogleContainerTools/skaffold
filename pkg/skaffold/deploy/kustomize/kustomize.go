...
func NewKustomizeDeployer(cfg kubectl.Config, labels map[string]string) (*KustomizeDeployer, error) {
	defaultNamespace := ""
...
func (k *KustomizeDeployer) renderManifests(ctx context.Context, out io.Writer, builds []build.Artifact) (manifest.ManifestList, error) {
...
func (k *KustomizeDeployer) readManifests(ctx context.Context) (manifest.ManifestList, error) {
