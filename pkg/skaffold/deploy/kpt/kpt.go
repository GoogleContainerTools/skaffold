...
import (
	...
	"github.com/GoogleContainerTools/skaffold/v2/pkg/skaffold/deploy/kustomize"
...
func NewDeployer(cfg Config, labels map[string]string, provider deploy.ComponentProvider, d *latestV2.KptDeploy) *Deployer {
