...
func TestHelmDeploy(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get all --namespace testReleaseNamespace skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeployNamespacedConfig,
			},
			builds: testBuilds,
		},
		{
		...
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeployRecreatePodsConfig,
			},
			builds: testBuilds,
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeploySkipBuildDependenciesConfig,
			},
			builds: testBuilds,
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeployConfigParameterUnmatched,
			},
			builds:    testBuilds,
			shouldErr: true,
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeploySkipBuildDependencies,
			},
			builds: testBuilds,
		},
		{
			...
			cfg: &helmConfig{
				deploy: testDeployUpgradeOnChange,
			},
		},
		{
		...
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeployHelmStyleConfig,
			},
			builds: testBuilds,
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeployHelmExplicitRegistryStyleConfig,
			},
			builds: testBuilds,
		},
		{
		...
		},
		{
			...
			shouldErr: false,
			cfg: &helmConfig{
				deploy: testDeployFooWithPackaged,
			},
		...
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get <no value>-skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeployWithTemplatedName,
			},
			builds: testBuilds,
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeployConfigTemplated,
			},
			builds: testBuilds,
		},
		{
			...
			commands: testutil.
				...
				AndRun("helm --kube-context kubecontext get skaffold-helm --kubeconfig kubeconfig"),
			cfg: &helmConfig{
				deploy: testDeployConfigValuesFilesTemplated,
			},
			builds: testBuilds,
		},
		{
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			deployer := NewHelmDeployer(test.cfg, nil)
...
func (c *helmConfig) GetKubeContext() string   { return testKubeContext }
func (c *helmConfig) GetKubeConfig() string    { return testKubeConfig }
