...
func (m DeployerMux) Deploy(ctx context.Context, w io.Writer, as []dep.Artifact) ([]string, error) {
...
func (m DeployerMux) Render(ctx context.Context, w io.Writer, as []dep.Artifact, offline bool, filepath string) error {
