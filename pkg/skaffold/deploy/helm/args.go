...
func constructOverrideArgs(r *latestV2.HelmRelease, builds []graph.Artifact, args []string) ([]string, error) {
...
func (h *Deployer) installArgs(r latestV2.HelmRelease, builds []graph.Artifact, o installOpts) ([]string, error) {
	var args []string
	if o.upgrade {
