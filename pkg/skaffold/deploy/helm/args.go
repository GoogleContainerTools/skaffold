...
func constructOverrideArgs(r *latestV2.HelmRelease, builds []graph.Artifact, args []string, record func(string)) ([]string, error) {
...
func (h *Deployer) installArgs(r latestV2.HelmRelease, builds []graph.Artifact, valuesSet map[string]bool, o installOpts) ([]string, error) {
	var args []string
	if o.upgrade {
