...
func TestNewDeployer(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			_, err := NewDeployer(&helmConfig{}, nil, &log.NoopProvider{}, &preview.NoopProvider{}, &debug.NoopProvider{}, &testDeployConfig)
...
func TestHelmDeploy(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			}, nil, &log.NoopProvider{}, &preview.NoopProvider{}, &debug.NoopProvider{}, &test.helm)
...
func TestHelmDependencies(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			deployer, err := NewDeployer(&helmConfig{}, nil, &log.NoopProvider{}, &preview.NoopProvider{}, &debug.NoopProvider{}, &latestV1.HelmDeploy{
				Releases: []latestV1.HelmRelease{{
					Name:                  "skaffold-helm",
					ChartPath:             local,
					RemoteChart:           remote,
...
func TestGenerateSkaffoldDebugFilter(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			h, err := NewDeployer(&helmConfig{}, nil, &log.NoopProvider{}, &preview.NoopProvider{}, &debug.NoopProvider{}, &testDeployConfig)
			t.RequireNoError(err)
