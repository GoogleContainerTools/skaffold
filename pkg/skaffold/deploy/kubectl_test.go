...
func (c *kubectlConfig) GlobalConfig() string                      { return "" }
func (c *kubectlConfig) GetKubeConfig() string                     { return "" }
func (c *kubectlConfig) GetKubeContext() string                    { return c.kubeContext }
