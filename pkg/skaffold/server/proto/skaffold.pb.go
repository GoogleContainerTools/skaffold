...
func (*StateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{0}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{1}
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{2}
}
...
func (*State) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{3}
}
...
func (*BuildState) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{4}
}
...
func (dst *BuildState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BuildState.Merge(dst, src)
}
...
func (*DeployState) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{5}
}
...
func (dst *DeployState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeployState.Merge(dst, src)
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{6}
}
...
func _Event_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Event_MetaEvent:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.MetaEvent); err != nil {
			return err
		}
	case *Event_BuildEvent:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.BuildEvent); err != nil {
			return err
		}
	case *Event_DeployEvent:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.DeployEvent); err != nil {
			return err
		}
	case *Event_PortEvent:
...
func _Event_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Event)
	switch tag {
	case 1: // event_type.metaEvent
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(MetaEvent)
		err := b.DecodeMessage(msg)
		m.EventType = &Event_MetaEvent{msg}
		return true, err
	case 2: // event_type.buildEvent
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(BuildEvent)
		err := b.DecodeMessage(msg)
		m.EventType = &Event_BuildEvent{msg}
		return true, err
	case 3: // event_type.deployEvent
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DeployEvent)
		err := b.DecodeMessage(msg)
		m.EventType = &Event_DeployEvent{msg}
		return true, err
	case 4: // event_type.portEvent
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(PortEvent)
		err := b.DecodeMessage(msg)
		m.EventType = &Event_PortEvent{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Event_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.EventType.(type) {
	case *Event_MetaEvent:
		s := proto.Size(x.MetaEvent)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Event_BuildEvent:
		s := proto.Size(x.BuildEvent)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Event_DeployEvent:
		s := proto.Size(x.DeployEvent)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Event_PortEvent:
...
func (*MetaEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{7}
}
...
func (dst *MetaEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetaEvent.Merge(dst, src)
}
...
func (*BuildEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{8}
}
...
func (*DeployEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{9}
}
...
func (*PortEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{10}
}
...
func (dst *PortEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PortEvent.Merge(dst, src)
}
...
func (*LogEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_skaffold_e59d83c5ffbd05f3, []int{11}
}
...
func init() { proto.RegisterFile("skaffold.proto", fileDescriptor_skaffold_e59d83c5ffbd05f3) }

var fileDescriptor_skaffold_e59d83c5ffbd05f3 = []byte{
