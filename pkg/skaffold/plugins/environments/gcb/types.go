...
// Init initializes the Blugin
func (b *ExecutionEnv) Init(runCtx *runcontext.RunContext) error {
	b.GoogleCloudBuild = runCtx.Cfg.Build.GoogleCloudBuild
	b.skipTests = runCtx.Opts.SkipTests
...
// func NewExecutionEnvFromPluginConfig(runCtx *runcontext.RunContext) (*Builder, error) {
