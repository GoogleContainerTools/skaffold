...
func ApplyProfiles(c *latestV2.SkaffoldConfig, fieldsOverrodeByProfile map[string]configlocations.YAMLOverrideInfo, opts cfg.SkaffoldOptions, namedProfiles []string) ([]string, map[string]configlocations.YAMLOverrideInfo, error) {
...
func activatedProfiles(profiles []latestV2.Profile, opts cfg.SkaffoldOptions, namedProfiles []string) ([]string, []string, error) {
...
func applyProfile(config *latestV2.SkaffoldConfig, fieldsOverrodeByProfile map[string]configlocations.YAMLOverrideInfo, profile latestV2.Profile) error {
...
func profilesByName(profiles []latestV2.Profile) map[string]latestV2.Profile {
	byName := make(map[string]latestV2.Profile)
	for _, profile := range profiles {
