...
func ApplyProfiles(c *latestV2.SkaffoldConfig, opts cfg.SkaffoldOptions, namedProfiles []string) ([]string, error) {
...
func applyProfile(config *latestV2.SkaffoldConfig, profile latestV2.Profile) error {
