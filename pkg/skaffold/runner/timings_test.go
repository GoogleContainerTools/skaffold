...
func (m *mockBuilder) Build(context.Context, io.Writer, tag.ImageTags, []*latest.Artifact) ([]dep.Artifact, error) {
	if m.err {
...
func (m *mockTester) Test(context.Context, io.Writer, []dep.Artifact) error {
	if m.err {
