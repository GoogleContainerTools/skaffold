...
func (f *fakeDepsResolver) TransitiveArtifactDependencies(context.Context, *latestV2.Artifact) ([]string, error) {
	return nil, nil
}

func (f *fakeDepsResolver) SingleArtifactDependencies(context.Context, *latestV2.Artifact) ([]string, error) {
	return nil, nil
}
