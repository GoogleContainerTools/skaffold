...
func (w withTimings) Build(ctx context.Context, out io.Writer, tags tag.ImageTags, platforms platform.Resolver, artifacts []*latestV2.Artifact) ([]graph.Artifact, error) {
