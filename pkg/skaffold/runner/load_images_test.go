	...
	tests := []ImageLoadingTest{
		{
			...
			cluster:     "kind",
			built:       []dep.Artifact{{Tag: "tag1"}},
			deployed:    []dep.Artifact{{Tag: "tag1"}},
			commands: testutil.
		...
		},
		{
			...
			cluster:     "other-kind",
			built:       []dep.Artifact{{Tag: "tag1"}, {Tag: "tag2"}},
			deployed:    []dep.Artifact{{Tag: "tag1"}, {Tag: "tag2"}},
			commands: testutil.
		...
		},
		{
			...
			cluster:     "kind",
			built:       []dep.Artifact{{Tag: "tag0"}, {Tag: "docker.io/library/tag1"}, {Tag: "docker.io/tag2"}, {Tag: "gcr.io/test/tag3"}, {Tag: "someregistry.com/tag4"}},
			deployed:    []dep.Artifact{{Tag: "tag0"}, {Tag: "docker.io/library/tag1"}, {Tag: "docker.io/tag2"}, {Tag: "gcr.io/test/tag3"}, {Tag: "someregistry.com/tag4"}},
			commands: testutil.
		...
		},
		{
			...
			built:       []dep.Artifact{{Tag: "tag"}},
			deployed:    []dep.Artifact{{Tag: "tag"}},
			commands: testutil.
		...
		},
		{
			...
			cluster:     "kind",
			built:       []dep.Artifact{{Tag: "built"}},
			deployed:    []dep.Artifact{{Tag: "built"}, {Tag: "busybox"}},
			commands: testutil.
				CmdRunOut("kubectl --context kubecontext --namespace namespace get nodes -ojsonpath='{@.items[*].status.images[*].names[*]}'", "").
		...
		},
		{
			...
			built:       []dep.Artifact{},
			deployed:    []dep.Artifact{{Tag: "busybox"}},
		},
	}
