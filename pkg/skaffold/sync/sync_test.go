...
func TestNewSyncItem(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			t.Override(&SyncMap, func(*latestV2.Artifact, docker.Config) (map[string][]string, error) { return test.dependencies, nil })
...
func TestSyncMap(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, test.description, func(t *testutil.T) {
			...
			syncMap, err := SyncMap(&latestV2.Artifact{ArtifactType: test.artifactType}, nil)
