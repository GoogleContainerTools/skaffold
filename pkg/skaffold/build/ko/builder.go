...
func (b *Builder) newKoBuilder(ctx context.Context, a *latestV2.Artifact, platforms platform.Matcher) (build.Interface, error) {
...
func buildOptions(a *latestV2.Artifact, runMode config.RunMode, platforms platform.Matcher) (*options.BuildOptions, error) {
