...
func (b *Builder) kanikoPodSpec(artifact *latestV2.KanikoArtifact, tag string, platforms platform.Matcher) (*v1.Pod, error) {
...
func (b *Builder) env(artifact *latestV2.KanikoArtifact, httpProxy, httpsProxy string) []v1.EnvVar {
	env := []v1.EnvVar{{
...
func resourceRequirements(rr *latestV2.ResourceRequirements) v1.ResourceRequirements {
...
func kanikoArgs(artifact *latestV2.KanikoArtifact, tag string, insecureRegistries map[string]bool) ([]string, error) {
