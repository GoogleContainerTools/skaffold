...
type cache struct {
	...
	artifactGraph      dep.ArtifactGraph
...
func NewCache(cfg Config, isLocalImage func(imageName string) (bool, error), dependencies DependencyLister, graph dep.ArtifactGraph, store build.ArtifactStore) (Cache, error) {
