...
func TestGetBuild(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			buildArtifact: func(ctx context.Context, out io.Writer, artifact *latestV2.Artifact, tag string) (string, error) {
...
func TestInOrder(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			buildFunc: func(ctx context.Context, out io.Writer, artifact *latestV2.Artifact, tag string) (string, error) {
...
func TestInOrderConcurrency(t *testing.T) {
	...
	for _, test := range tests {
		testutil.Run(t, fmt.Sprintf("%d artifacts, max concurrency=%d", test.artifacts, test.limit), func(t *testutil.T) {
			...
			builder := func(_ context.Context, _ io.Writer, _ *latestV2.Artifact, tag string) (string, error) {
...
func TestInOrderForArgs(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			buildArtifact: func(_ context.Context, _ io.Writer, _ *latestV2.Artifact, tag string) (string, error) {
				return tag, nil
			},
			artifactLen: 2,
			expected: []graph.Artifact{
		...
		},
		{
			...
			buildArtifact: func(c context.Context, _ io.Writer, a *latestV2.Artifact, tag string) (string, error) {
		...
		},
		{
			...
			buildArtifact: func(_ context.Context, _ io.Writer, a *latestV2.Artifact, tag string) (string, error) {
				if a.ImageName == "artifact2" {
					return "", fmt.Errorf(`some error occurred while building "artifact2"`)
				}
				return tag, nil
