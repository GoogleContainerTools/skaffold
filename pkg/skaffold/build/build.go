...
type Build struct {
	ImageName string
	Tag       string
	Artifact  *v1alpha1.Artifact // The artifact used in the build.
}
...
type Builder interface {
	Build(ctx context.Context, out io.Writer, tagger tag.Tagger, artifacts []*v1alpha1.Artifact) (*BuildResult, error)
}
