...
type ArtifactStore interface {
	Record(a *latestV2.Artifact, tag string)
	GetImageTag(imageName string) (tag string, found bool)
	GetArtifacts(s []*latestV2.Artifact) ([]graph.Artifact, error)
}
...
func (ba *artifactStoreImpl) Record(a *latestV2.Artifact, tag string) {
...
func (ba *artifactStoreImpl) GetArtifacts(s []*latestV2.Artifact) ([]graph.Artifact, error) {
