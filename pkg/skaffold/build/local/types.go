...
func NewBuilder(ctx context.Context, bCtx BuilderContext, buildCfg *latestV2.LocalBuild) (*Builder, error) {
...
func newPerArtifactBuilder(b *Builder, a *latestV2.Artifact) (artifactBuilder, error) {
	switch {
