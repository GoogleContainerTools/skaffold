...
func processEachConfig(config *latestV2.SkaffoldConfig, cfgOpts configOpts, opts config.SkaffoldOptions, r *record, index int) (SkaffoldConfigSet, error) {
...
func processEachDependency(d latestV2.ConfigDependency, cfgOpts configOpts, opts config.SkaffoldOptions, r *record) (SkaffoldConfigSet, error) {
...
func cacheRepo(g latestV2.GitInfo, opts config.SkaffoldOptions, r *record) (string, error) {
