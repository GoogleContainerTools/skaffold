...
func (t FullTester) TestDependencies(ctx context.Context, artifact *latestV2.Artifact) ([]string, error) {
	var deps []string
...
func getImageTesters(ctx context.Context, cfg docker.Config, imagesAreLocal func(imageName string) (bool, error), tcs []*latestV2.TestCase) (ImageTesters, error) {
