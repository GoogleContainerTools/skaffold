...
func TestParseReference(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			image:                  "ko://github.com/GoogleContainerTools/skaffold",
			expectedName:           "github.com/googlecontainertools/skaffold",
			expectedTag:            "",
			expectedFullyQualified: false,
		},
		{
		...
		},
		{
			...
			image:                  "us-central1-docker.pkg.dev/k8s-skaffold/Example:Tag@sha256:81daf011d63b68cfa514ddab7741a1adddd59d3264118dfb0fd9266328bb8883",
			expectedName:           "us-central1-docker.pkg.dev/k8s-skaffold/example",
			expectedTag:            "Tag",
			expectedDigest:         "sha256:81daf011d63b68cfa514ddab7741a1adddd59d3264118dfb0fd9266328bb8883",
			expectedFullyQualified: true,
		},
