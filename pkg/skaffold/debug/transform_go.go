...
func (t dlvTransformer) Apply(container *v1.Container, config imageConfiguration, portAlloc portAllocator, overrideProtocols []string) (debugutil.ContainerDebugConfiguration, string, error) {
	...
	if spec == nil {
		...
		default:
			return debugutil.ContainerDebugConfiguration{}, "", fmt.Errorf("container %q has no command-line", container.Name)
		}
	}
