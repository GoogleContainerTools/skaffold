...
func TestJdwpTransformerApply(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			debugConfig: util.ContainerDebugConfiguration{Runtime: "jvm", Ports: map[string]uint32{"jdwp": 5005}},
		},
		{
		...
		},
		{
			...
			debugConfig: util.ContainerDebugConfiguration{Runtime: "jvm", Ports: map[string]uint32{"jdwp": 8000}},
		},
		{
