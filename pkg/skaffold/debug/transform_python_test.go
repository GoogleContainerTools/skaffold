...
func TestPythonTransformer_Apply(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			debugConfig: util.ContainerDebugConfiguration{Runtime: "python", Ports: map[string]uint32{"dap": 5678}},
			image:       "python",
		},
		{
			...
			debugConfig: util.ContainerDebugConfiguration{Runtime: "python", Ports: map[string]uint32{"pydevd": 5678}},
			image:       "python",
		},
		{
