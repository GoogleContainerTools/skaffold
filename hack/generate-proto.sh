...
docker build -t gen-proto -f hack/proto/Dockerfile --target generateFiles proto
...
docker run --rm gen-proto cat index.md > docs/content/en/docs/references/api/_index.md
