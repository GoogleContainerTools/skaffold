...
func request_SkaffoldService_UpdateAutoTrigger_0(ctx context.Context, marshaler runtime.Marshaler, client SkaffoldServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AutoTriggerRequest
	var metadata runtime.ServerMetadata
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.Phase); err != nil && err != io.EOF {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.UpdateAutoTrigger(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func RegisterSkaffoldServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SkaffoldServiceClient) error {
	...
	mux.Handle("POST", pattern_SkaffoldService_UpdateAutoTrigger_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
		...
		resp, md, err := request_SkaffoldService_UpdateAutoTrigger_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_SkaffoldService_UpdateAutoTrigger_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_SkaffoldService_UpdateAutoTrigger_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "update", "trigger"}, ""))
...
var (
	...
	forward_SkaffoldService_UpdateAutoTrigger_0 = runtime.ForwardResponseMessage
