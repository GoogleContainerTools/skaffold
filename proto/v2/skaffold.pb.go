...
const StatusCode_DEPLOY_KPT_APPLY_ERR = StatusCode(enums.StatusCode_DEPLOY_KPT_APPLY_ERR)
...
const SuggestionCode_ALIGN_KPT_INVENTORY = SuggestionCode(enums.SuggestionCode_ALIGN_KPT_INVENTORY)
