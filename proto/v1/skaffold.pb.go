...
const StatusCode_TEST_CT_USER_ERR = StatusCode(enums.StatusCode_TEST_CT_USER_ERR)
const StatusCode_TEST_CT_CMD_PARSE_ERR = StatusCode(enums.StatusCode_TEST_CT_CMD_PARSE_ERR)
const StatusCode_TEST_CT_CMD_NON_ZERO_EXIT_ERR = StatusCode(enums.StatusCode_TEST_CT_CMD_NON_ZERO_EXIT_ERR)
const StatusCode_TEST_CT_CMD_TIMEDOUT_OR_CANCELLED_ERR = StatusCode(enums.StatusCode_TEST_CT_CMD_TIMEDOUT_OR_CANCELLED_ERR)
const StatusCode_TEST_CT_CMD_EXITED_ERR = StatusCode(enums.StatusCode_TEST_CT_CMD_EXITED_ERR)
const StatusCode_TEST_CT_CMD_RUN_ERR = StatusCode(enums.StatusCode_TEST_CT_CMD_RUN_ERR)
const StatusCode_TEST_CT_DEPS_CMD_ERR = StatusCode(enums.StatusCode_TEST_CT_DEPS_CMD_ERR)
const StatusCode_TEST_CT_DEPS_UNMARSHALL_ERR = StatusCode(enums.StatusCode_TEST_CT_DEPS_UNMARSHALL_ERR)
