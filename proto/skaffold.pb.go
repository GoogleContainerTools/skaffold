...
type ResourceStatusCheckEvent struct {
	...
	ErrorCode            ErrorCode `protobuf:"varint,5,opt,name=errorCode,proto3,enum=proto.ErrorCode" json:"errorCode,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}
...
func (m *ResourceStatusCheckEvent) GetErrorCode() ErrorCode {
	if m != nil {
		return m.ErrorCode
	}
	return ErrorCode_COULD_NOT_DETERMINE
...
var fileDescriptor_4f2d38e344f9dbf5 = []byte{
	...
	,
}
