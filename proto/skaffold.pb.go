...
type DebuggingContainerEvent struct {
	...
	ArtifactImage        string            `protobuf:"bytes,5,opt,name=artifactImage,proto3" json:"artifactImage,omitempty"`
	...
	Ports                map[string]uint32 `protobuf:"bytes,8,rep,name=ports,proto3" json:"ports,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *DebuggingContainerEvent) GetArtifactImage() string {
	if m != nil {
		return m.ArtifactImage
	}
	return ""
}
...
func (m *DebuggingContainerEvent) GetPorts() map[string]uint32 {
	if m != nil {
		return m.Ports
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]uint32)(nil), "proto.DebuggingContainerEvent.PortsEntry")
...
var fileDescriptor_4f2d38e344f9dbf5 = []byte{
	...
	,
}
