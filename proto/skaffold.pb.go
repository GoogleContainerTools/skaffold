...
type SkaffoldServiceClient interface {
	...
	// EventLog is DEPRECATED. It does the same as Events.
	EventLog(ctx context.Context, opts ...grpc.CallOption) (SkaffoldService_EventLogClient, error)
	// Events returns all the events of the current Skaffold execution from the start
	Events(ctx context.Context, opts ...grpc.CallOption) (SkaffoldService_EventsClient, error)
	// Handle is an experimental feature that allows for custom events to be implemented in custom builders for example
