...
const (
	...
	// Unknown Error Codes
	ErrorCode_ErrorCode_UNKNOWN ErrorCode = 501
	// Status Check error unknown
	ErrorCode_STATUS_CHECK_UNKNOWN ErrorCode = 502
	// Container is unschedulable due to unknown reasons
	ErrorCode_STATUS_CHECK_UNKNOWN_UNSCHEDULABLE ErrorCode = 503
	// Container is waiting due to unknown reason
	ErrorCode_STATUS_CHECK_CONTAINER_WAITING_UNKNOWN ErrorCode = 504
	// File Sync Initialize failure
	ErrorCode_FILE_SYNC_INIT_ERROR ErrorCode = 601
	// Failed to configure watcher for build dependencies in dev loop
	ErrorCode_DEV_REGISTER_BUILD_DEPS ErrorCode = 701
	// Failed to configure watcher for test dependencies in dev loop
	ErrorCode_DEV_REGISTER_TEST_DEPS ErrorCode = 702
	// Failed to configure watcher for deploy dependencies in dev loop
	ErrorCode_DEV_REGISTER_DEPLOY_DEPS ErrorCode = 703
	// Failed to configure watcher for Skaffold configuration file.
	ErrorCode_DEV_REGISTER_CONFIG_DEP ErrorCode = 704
)
...
var ErrorCode_name = map[int32]string{
	...
	501: "ErrorCode_UNKNOWN",
	502: "STATUS_CHECK_UNKNOWN",
	503: "STATUS_CHECK_UNKNOWN_UNSCHEDULABLE",
	504: "STATUS_CHECK_CONTAINER_WAITING_UNKNOWN",
	601: "FILE_SYNC_INIT_ERROR",
	701: "DEV_REGISTER_BUILD_DEPS",
	702: "DEV_REGISTER_TEST_DEPS",
	703: "DEV_REGISTER_DEPLOY_DEPS",
	704: "DEV_REGISTER_CONFIG_DEP",
}
...
var ErrorCode_value = map[string]int32{
	...
	"STATUS_CHECK_UNKNOWN":                   502,
	"STATUS_CHECK_UNKNOWN_UNSCHEDULABLE":     503,
	"STATUS_CHECK_CONTAINER_WAITING_UNKNOWN": 504,
	"FILE_SYNC_INIT_ERROR":                   601,
	"DEV_REGISTER_BUILD_DEPS":                701,
	"DEV_REGISTER_TEST_DEPS":                 702,
	"DEV_REGISTER_DEPLOY_DEPS":               703,
	"DEV_REGISTER_CONFIG_DEP":                704,
}
...
func (m *DevLoop) GetErrCode() ErrorCode {
	if m != nil {
		return m.ErrCode
	}
...
type DeployMetadata_Deployer struct {
	...
	Count                int32        `protobuf:"varint,2,opt,name=count,proto3" json:"count,omitempty"`
	ChangeType           ChangeType   `protobuf:"varint,3,opt,name=changeType,proto3,enum=proto.ChangeType" json:"changeType,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *DeployMetadata_Deployer) GetChangeType() ChangeType {
	if m != nil {
		return m.ChangeType
	}
	return ChangeType_INITIAL_LOOP
...
type EndEvent struct {
	ErrCode              ErrorCode  `protobuf:"varint,1,opt,name=errCode,proto3,enum=proto.ErrorCode" json:"errCode,omitempty"`
	ErrMsg               string     `protobuf:"bytes,2,opt,name=errMsg,proto3" json:"errMsg,omitempty"`
	Loops                []*DevLoop `protobuf:"bytes,3,rep,name=loops,proto3" json:"loops,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *EndEvent) GetErrCode() ErrorCode {
	if m != nil {
		return m.ErrCode
	}
	return ErrorCode_COULD_NOT_DETERMINE
...
func (m *EndEvent) GetErrMsg() string {
	if m != nil {
		return m.ErrMsg
	}
	return ""
...
type DevLoopEvent struct {
	...
	Err                  *ActionableErr `protobuf:"bytes,4,opt,name=err,proto3" json:"err,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *ActionableErr) GetErrCode() ErrorCode {
	if m != nil {
		return m.ErrCode
	}
	return ErrorCode_COULD_NOT_DETERMINE
...
func (m *ActionableErr) GetSuggestions() []string {
	if m != nil {
...
var fileDescriptor_4f2d38e344f9dbf5 = []byte{
	...
	,
}
