...
This is a simple example of using a docker build plugin with Google Cloud Build based on

* *building* a single go file app and with a multistage `Dockerfile` using docker in GCB
