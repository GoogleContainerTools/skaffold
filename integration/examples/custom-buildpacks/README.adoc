...
First, clone the Skaffold https://github.com/GoogleContainerTools/skaffold[repo] and navigate to the https://github.com/GoogleContainerTools/skaffold/tree/master/examples/custom-buildpacks[buildpacks example] for sample code:
...
ifndef::env-github[]
==== link:{github-repo-tree}/examples/custom-buildpacks[Example files icon:github[]]
