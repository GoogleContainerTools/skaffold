...
func TestFix(t *testing.T) {
	fixCmd := exec.Command("skaffold", "fix", "-f", "skaffold.yaml.old", "--overwrite")
	fixCmd.Dir = "../examples/old-config"
	...
	runCmd := exec.Command("skaffold", "run", "-f", "skaffold.yaml.old")
	runCmd.Dir = "../examples/old-config"
