...
ifeq ($(GCP_ONLY),true)
	...
	@ GCP_ONLY=$(GCP_ONLY) ./hack/gotest.sh -v $(REPOPATH)/integration/binpack $(REPOPATH)/integration -timeout 100m -run=TestDevGracefulCancel/multi-config-microservices -count=100
