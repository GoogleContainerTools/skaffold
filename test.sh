...
for i in `seq 100`; do
    echo $i ; go test -count=1 -race -cover -short -timeout=60s -coverprofile=out/coverage.txt -coverpkg="./pkg/...,./cmd/..." ./... github.com/GoogleContainerTools/skaffold/pkg/skaffold/watch ;
done
