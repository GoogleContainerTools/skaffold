---
title: "Skaffold Documentation: Getting Started"
...
and workflows; see [How-to Guides](/how-tos) and [Tutorials](/tutorials) for
more information.
...
<span style="font-size: 36pt"> :sparkles: </span>
...
For more in-depth topics of Skaffold, explore [Skaffold Concepts: Configuration](/concepts/config),
[Skaffold Concepts: Workflow](/concepts/workflow), and [Skaffold Concepts: Architecture](/config/architecture).

To learn more about how Skaffold builds, tags, and deploys your app, see the How-to Guides on 
[Using Builders](/how-tos/builders), [Using Taggers](/how-tos/taggers), and [Using Deployers](/how-tos/deployers).

[Skaffold Tutorials](/tutorials) details some of the common use cases of Skaffold.
