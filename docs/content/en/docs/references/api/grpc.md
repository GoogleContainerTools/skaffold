...
| TEST_CT_CMD_TIMEOUT_READ_ERR | 1106 | Error retrieving timeout |
| TEST_CT_CMD_RUN_ERR | 1107 | Error starting cmd run |
| TEST_CT_CMD_TIMEDOUT_ERR | 1108 | Command timed out |
| TEST_CT_CMD_NON_ZERO_EXIT_ERR | 1110 | Command returned non-zero exit code |
